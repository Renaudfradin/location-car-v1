    ...
    <?php  //$cars = $bdd->query5('SELECT * FROM cars LIKE "%BMW%" ') ?>
        <?php foreach ($cars as $car) { ?>
            <div class="locattion">
                    ...
                    <a href="page-info-location-UK.php?model=<?= $car->model ?>"><img src='../compte/photocars/car/<?=$car->picture?>' width="200px" height="150px" class="imglocation"></a><br>
                    <div class="price">
                     <?=$car->price?> $<br>   
                    </div>
                    <a href='page-addlocation-UK.php?id=<?= $car->id ?>' class="addPanier"><button class="btnlouer1">TO RENT</button></a><br><br><br>
            </div>
    <?php } ?>
</div>
