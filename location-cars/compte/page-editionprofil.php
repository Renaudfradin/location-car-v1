...
<table>
 <form method="POST"action="" enctype="multipart/form-data" class="tooutlestable">
  ...
  <tr>
    <td>
  <label for="newgenre">Civilité :</label>
    </td>
  ...
  <tr>
    <td>
      <label for="newpasswords">Mot-de-passe :</label>
    </td>
    <td>
      <input type="password" name="newpasswords" id="newpasswords" placeholder="votre new mot-de-passe" ><br /><br />
    </td>
  </tr>

  <tr>
    <td>
      <label for="newpasswords2">Confimer votre Mot-de-passe :</label>
    </td>
    <td>
      <input type="password" name="newpasswords2" id="newpasswords2" placeholder="confirmer votre new mot-de-passe" ><br /><br />
    </td>
  </tr>
  ...
  <tr>
    <td>
      <label for="newemail2">Confirmer votre Mail :</label>
    </td>
    <td>
  ...
  <tr>
    <td>
      <label for="newlocations">Adresse :</label>
    </td>
    <td>
  ...
  <tr>
    <td>
      <label for="newphone">num tell :</label>
    </td>
    <td>
